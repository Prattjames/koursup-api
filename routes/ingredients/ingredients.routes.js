...
const getIngredientByIdRoute = async (req, res) => {
	try {
		const ingredientData = await ingredients(req.params.id)
...
const createIngredientRoute = async (req, res) => {
	try {
		...
		const newIngredientData = await createIngredient({ name, price })
...
const updateIngredientByIdRoute = async (req, res) => {
	try {
		const oldIngredientData = await updateIngredient(req.params.id, req.body)
